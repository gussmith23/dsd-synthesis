...
that can potentially lead to a strand displacement reaction (where a strand is
released from the gate). The infinite abstraction also allows for the strand
displacement reaction itself (which is specified by another reduction rule, RD)
to be merged into the reaction.
